...
function SuperStockerConfigurator({isOpen,handleClose,onSubmit, drawerData:{isEdit,data}}) {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator:isOpen }}>
      <SoftBox display="flex" justifyContent="space-between" alignItems="baseline" pt={3} pb={0.8} px={3}>
        <SoftBox>
          <SoftTypography variant="h5">{isEdit ? "Edit" : "Add"} Super Stocker</SoftTypography>
        </SoftBox>
        <Icon
...
export default SuperStockerConfigurator;
